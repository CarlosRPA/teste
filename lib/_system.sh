...
system_unzip_agilizap() {
  print_banner
  printf "${WHITE} 💻 Extraindo o Multiconversa...${GRAY_LIGHT}"
  printf "\n\n"
...
deletar_tudo() {
  print_banner
  printf "${WHITE} 💻 Vamos deletar uma Instância do Multiconversa...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_desbloqueio() {
  print_banner
  printf "${WHITE} 💻 Vamos Desbloquear o Multiconversa de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
...
configurar_dominio() {
  print_banner
  printf "${WHITE} 💻 Vamos alterar os domínios do Multiconversa de uma Instância...${GRAY_LIGHT}"
  printf "\n\n"
